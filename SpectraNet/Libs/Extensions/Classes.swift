...
extension UIViewController
{
   func noInternetCheckScreenWithMessage(errorMessage: String)
    {
        let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: ViewIdentifier.NoInternetIdentifier) as? NoInternetViewController
    ...
    func privacPolicyView(withLink: String)
    {
        ...
        {
            let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: ViewIdentifier.privacyIdentifier) as? PrivacyPolicyViewController
    ...
    {
        let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: ViewIdentifier.changePlaneIndetifier) as? ChangePlanViewController
        vc?.canID = WithCanID
        vc?.pckgID = pckgID
    ...
    func topupScreen(WithCanID: String, pckgID: String)
       {
           let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: ViewIdentifier.topupIdentifier) as? TopupPlanViewController
           vc?.canID = WithCanID
           vc?.basePlan = pckgID
           self.navigationController?.pushViewController(vc!, animated: false)
       }
...
//
    ...
    {
        let vc = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: ViewIdentifier.siTermCondition) as? SIPrivacyPolicyViewController
